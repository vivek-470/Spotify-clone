...
const premium = () => {
  return (
    <div className=' md:h-[700px] h-[800px] w-full md:max-w-[1530px] max-w-xl bg-gray-800 relative '>
      <div className='  md:h-[60px] md:w-[100%]  absolute '>
        ...
        <div className=' md:max-w-[580px] md:h-[500px] text-white md:mt-[-400px] md:ml-[150px] max-w-[500px] flex flex-col  md:items-start items-center  '>
          ...
          <div className='mt-[25px] gap-[20px] flex flex-col md:flex-row'>
            <button className='bg-white text-black h-[50px] w-[340px] md:w-[200px] font-bold rounded-3xl hover:scale-110 transition-transform ease-in-out'>Try 2 months for ₹119</button>
            <button className='bg-black text-white h-[50px] md:w-[200px] w-[340px] rounded-3xl font-bold hover:scale-110 transition-transform ease-in-out'>View all plans</button>
          </div>
          <h1 className='text-[12px] md:w-[320px]  mt-[20px]'>₹119 for 2 months, then ₹119 per month after. Offer only available if you haven’t tried Premium before. Terms apply.</h1>
