...
const Support = () => {
  return (
    <div className='h-[1000px] relative  w-full max-w-[1530px] flex sm:flex-col md:flex-row  items-center min-h-screen bg-black  border-t-2 border-gray-800  '>
      ...
      <div className='bg-white md:w-[500px] w-[320px] h-[45px] flex mt-14 rounded-[8px] '>
      ...
      <div className='bg-gray-800 h-[400px] w-[320px] md:w-[500px] mt-[50px] rounded-[7px]  text-white'>
